...
public class XLSX2CSV {
	...
	// TODO catch exceptions
		public XLSX2CSV(InputStream input, String outputFilePath) throws Exception {
			xlsxPackage = OPCPackage.open(input);
			output = new PrintStream(outputFilePath, OUTPUT_CHARSET);
			minColumns = -1;
		}
	...
	public static void main(String[] args) throws Exception {
		XLSX2CSV xlsx2csv = new XLSX2CSV("data\\联系方式.xlsx", "data\\outs.csv");
		xlsx2csv.process();
	}
