...
public interface FivegMroDataDao {
    ...
    public void analysisMroData(@Param("mroCoverTable")String mroCoverTable,@Param("mroTable")String mroTable,@Param("date") String date, @Param("earfcn") List<Integer> earfcn);
